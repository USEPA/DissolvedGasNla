...
```{r}
# Read data file commented out b/c dataMunge.Rmd creates dg assignment based on latest text file nla17gasDataAggregated_2020-10-08.txt
 # load(paste0(localPath, 
 #            "/Environmental Protection Agency (EPA)/",
 #            "ORD NLA17 Dissolved Gas - Documents/",
 #            "inputData/dg.2020-10-09.RData"))
...
dg %>% filter(WSA9 != "AK") %>% 
  ggplot(aes(as.factor(x = WSA9), y = log(dissolved.n2o))) + geom_boxplot()
...
dg_sf1 <- filter(dg_sf1, sample_source == "DG") # now 1219 obs vs. previously 1185 obs., why change in sample size
st_crs(dg_sf1)
