...
dg_1 <- select(dg,site.id:map.lon.dd, dissolved.co2.umol, dissolved.ch4.umol, dissolved.n2o.nmol, WSA9, WSA9_NAME)
names(dg_1)
dg_1 <- clean_names(dg_1) %>% filter(wsa9 != "AK") # underscores are "safer" names used in GIS
names(dg_1)
# To enable spatial analysis of the data, the dataframe will be converted to a 'simple features' (sf) object.
# Define coordinates
...
names(dg)
dg_1 <- clean_names(dg)
# also includ WSA9, WSA9_NAME feature plus variables from Jake's 02/25/2020 email
