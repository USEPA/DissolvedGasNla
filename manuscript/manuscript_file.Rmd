...
Despite widespread N~2~O undersaturation in CONUS waterbodies, the mean predicted N~2~O saturation ratio (ratio of measured to equilibrium concentration) was statistically indistinguishable from one in all ecoregions **(Table 1, Fig. 2)**. The apparent contradiction between widespread N~2~O undersaturation and average dissolved N~2~O concentrations close to equilibrium can be attributed to the predicted distribution of dissolved N~2~O concentrations across the population of CONUS waterbodies **(Fig. 2)**. Across the CONUS, and within each of the nine major ecoregions, the predicted distribution of N~2~O saturation ratios had median values less than 1, indicating undersaturation, but a long right tail composed of relatively rare waterbodies with levels of N~2~O supersaturation that are sufficiently high to drive the population mean to values close to, or even greater than 1. Thus most waterbodies in the CONUS are functioning as N~2~O sinks during the summer months, but a few function as strong N~2~O sources, particularly at high NO~3~ at high water temperature **(Fig. 3)**.
